...
public class SoundBuilder {
     ...
     */
    public SoundBuilder(){
        this(Sound.ENTITY_VILLAGER_NO, 1, 1);
    }
    ...
    /**
     * Creates an SoundBuilder from {@link MotherSound}.
     *
     * @param sound {@link MotherSound} that will be copied.
     */
    public SoundBuilder(MotherSound sound){
    ...
    /**
     * Creates MotherSound from selected values.
     *
     * @return {@link MotherSound} consisting of all previously selected values.
     */
    public MotherSound create(){
        return new MotherSound(sound, volume, pitch);
    }
}
