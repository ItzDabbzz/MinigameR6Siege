...
public class FireworkManager implements Listener {
    ...
    /** The instance. */
    static FireworkManager instance = new FireworkManager();

    /**
     * Gets the single instance of FireworkManager.
     *
     * @return single instance of FireworkManager
     */
    ...
    /** The plugin. */
    R6Siege plugin = R6Siege.getInstance();

    /**
     * Instantiates a new FireworkManager.
     */
